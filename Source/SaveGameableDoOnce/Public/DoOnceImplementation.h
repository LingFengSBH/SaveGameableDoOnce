...
class SAVEGAMEABLEDOONCE_API UDoOnceImplementation : public UObject
{
	...
	UFUNCTION(BlueprintCallable,BlueprintInternalUseOnly,Category = "SaveGameableDoOnce|K2Node Implementation Functions")
	...
	UFUNCTION(BlueprintCallable,BlueprintInternalUseOnly,BlueprintPure,Category = "SaveGameableDoOnce|K2Node Implementation Functions")
